...
def draw_battle(bg, fnt):
    ...
    if equipped_charm:
        ...
        status_y += 24
    total_crit_pct = int(round((skill_crit_chance + modifier_crit_chance_bonus() + char_params()["crit_bonus"] + relic_crit_bonus() + charm_crit_bonus()) * 100))
    if total_crit_pct > 0:
    ...
    while True:
        ...
        if idx == 0:
            ...
            if tmr ==1:
                ...
                total_crit_chance = skill_crit_chance + modifier_crit_chance_bonus() + char_params()["crit_bonus"] + relic_crit_bonus() + charm_crit_bonus()
