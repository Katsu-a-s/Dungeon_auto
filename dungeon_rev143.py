...
FLOOR_MODIFIERS = {
    ...
    "feral":     {"name": "Feral Floor",     "desc": "Monster encounters are far more common here", "color": (150, 60, 40)},
}
...
def modifier_encounter_mult():
    ...
    間引き、通常より静かに探索できるようにする倍率。対になるFeral Floorでは
    逆に遭遇マスを増やし、モンスターとの遭遇頻度そのものが上がる特性が
    veiledの間引き方向にしか無かった穴を埋める新しい方向性として追加した。"""
