...
ACHIEVEMENT_DEFS = [
    ...
    # hero_awakened(初回覚醒)・full_ascension(全19人覚醒)の2段構成は
    # 他の「初回+累積(全種)」実績と同じパターン。rev215でVirtuosoが
    # 19人目として加わったため、判定はlen(CHARACTER_ORDER)を参照しており
    # 表記のみ18→19に更新した。
    ("hero_awakened", "Awaken your first Hero"),
    ("full_ascension", "Awaken all 19 Heroes"),
    ...
    ("grand_transcendence", "Transcend all 19 Heroes"),
...
ACHIEVEMENT_PROGRESS = {
    ...
    "full_ascension": ("characters_awakened_count", 19),
    ...
    "grand_transcendence": ("characters_transcended_count", 19),
...
CHARACTER_ORDER = ["warrior", "guardian", "scholar", "scout", "rogue", "berserker", "prospector", "trader", "monk", "cleric", "pyromancer", "duelist", "reaver", "vagabond", "apothecary", "marshal", "ranger", "vanguard", "virtuoso"]
HERO_GRID_ROWS = 10  # キャラクター選択画面(idx==49)のグリッド行数。2列×10行=20枠。rev204のMarshal追加で2列×8行(16枠)が埋まりきった後、rev209のRanger追加で2列×9行、rev211のVanguard追加で18/18枠が埋まり、rev215のVirtuoso追加で2列×10行(20枠、19/20)に拡張した。
