...
ACHIEVEMENT_DEFS = [
    ...
    # hero_awakened(初回覚醒)・full_ascension(全17人覚醒)の2段構成は
    # 他の「初回+累積(全種)」実績と同じパターン。
    ("hero_awakened", "Awaken your first Hero"),
    ("full_ascension", "Awaken all 17 Heroes"),
...
ACHIEVEMENT_PROGRESS = {
    ...
    "full_ascension": ("characters_awakened_count", 17),
...
CHARACTER_ORDER = ["warrior", "guardian", "scholar", "scout", "rogue", "berserker", "prospector", "trader", "monk", "cleric", "pyromancer", "duelist", "reaver", "vagabond", "apothecary", "marshal", "ranger"]
HERO_GRID_ROWS = 9  # キャラクター選択画面(idx==49)のグリッド行数。2列×9行=18枠。rev204のMarshal追加で2列×8行(16枠)が埋まりきった後、rev209のRanger追加でさらに2列×9行に拡張した(あと1枠は将来の増員用の空き)。
