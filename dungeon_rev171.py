...
CHARACTER_ORDER = ["warrior", "guardian", "scholar", "scout", "rogue", "berserker", "prospector"]
...
def move_player(key):
    ...
    if dungeon[pl_y][pl_x] == 1:
        ...
        ib = diff_params()["item_bonus"] + skill_item_bonus + pet_item_bonus + modifier_item_bonus() + char_params()["item_bonus"]
...
def main():
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_n and idx == 0:
                    ...
                    tmr = 0
                if idx == 49:
                    char_key_map = {K_1: 0, K_2: 1, K_3: 2, K_4: 3, K_5: 4, K_6: 5, K_7: 6}
        ...
        if idx == 0:
            ...
            draw_text(screen, "[1-7] Choose   [Esc] Back", 260, 636, fontS, WHITE)
            ...
            # 適用した(0の時は表示しない)。
            item_find_total = diff_params()["item_bonus"] + skill_item_bonus + pet_item_bonus + modifier_item_bonus() + char_params()["item_bonus"]
