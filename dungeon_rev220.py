...
def start_hidden_stage_challenge():
    ...
    global food, food_acc, potion, blazegem, pl_poison, pl_bleed, pl_frozen, pl_weaken, pl_sunder, pl_restrain, pl_charge, battle_took_damage
...
def init_battle():
    ...
    global pl_charge, pl_poison, pl_bleed, pl_frozen, pl_weaken, pl_sunder, pl_restrain, battle_took_damage
    ...
    if floor > 90:
        ...
        typ = random.choice(list(range(8, 32)) + [32, 33, 36, 38, 39, 40, 41, 42, 43, 44, 45])
        ...
        # typ44「Rust Golem」(今回追加分)もfloor>=30から混ざる帯として、ここでも引き続き出現させる。
        # typ45「Grasping Revenant」(今回追加分)もfloor>=30から混ざる帯として、ここでも引き続き出現させる。
        typ = random.choice(list(range(8, 32)) + [33, 36, 38, 39, 40, 41, 42, 43, 44, 45])
        lev = random.randint(floor - 2, floor)
    elif floor >= 30:
        ...
        typ = random.choice(list(range(8, 27)) + [30, 31, 33, 38, 39, 41, 42, 43, 44, 45])
        lev = random.randint(floor - 2, floor)
    elif floor >= 15:
...
def main():
    ...
    global pl_exp_mult, pl_charge, pl_poison, pl_bleed, pl_frozen, pl_weaken, pl_sunder, pl_restrain
