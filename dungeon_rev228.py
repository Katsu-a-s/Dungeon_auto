    ...
    while True:
        ...
        if idx == 0:
            ...
            if tmr == 9:
                ...
                if typ in (5, 7, 14) and pl_poison == 0 and not modifier_poison_immune() and random.randint(0, 99) < 30 + modifier_poison_chance_bonus() - char_params().get("status_resist_bonus", 0) - modifier_status_resist_bonus():
                    pl_poison = 50
