...
CHARACTER_ORDER = ["warrior", "guardian", "scholar", "scout", "rogue", "berserker", "prospector", "trader", "monk", "cleric"]
    ...
    while True:
        ...
        if idx == 0:
            ...
            for i, cid in enumerate(CHARACTER_ORDER):
                ...
                draw_text(screen, f"{mark}[{key_label}] {c['name']}", gx + GRID_TEXT_DX, y0, fontS, col)
            ...
            draw_text(screen, "[0-9] Choose   [Esc] Back", 260, grid_bottom + 76, fontS, WHITE)
